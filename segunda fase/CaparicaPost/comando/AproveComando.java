 ...
 * @author gil
 */
public class AproveComando extends ComandoManipuladorClasse {

    public AproveComando(Scanner line, String[] comando, CaparicaPost caparica) throws ComandoIlegalException {
    ...
    public void execucao() throws ComandoIlegalException {
        ...
        getCaparica().Approve(titulo, data);
