...
public class CaparicaPostClass implements CaparicaPost {
    ...
    public void RegisterUser(String type, String name, String email, String theme) throws ExceptionUserLoggedIn {
        ...
        if (currentUser == null && !HasUser(name)) {
            switch(type.toUpperCase()) {
                case "READER":
                    userList.add(new Reader(type, name, email));
                    break;
                case "EDITOR":
                    userList.add(new Editor(type, name, email, theme));
                    break;
                case "JOURNALIST":
                    userList.add(new Journalist(type, name, email, theme));
                    break;
                case "COLLABORATOR":
                    userList.add(new Collaborator(type, name, email));
                    break;
            }
    ...
    public void ListUserByType(String type) {
        for (int i = 0; i < userList.size(); i++) {
            if (userList.get(i).GetType().equalsIgnoreCase(type) && userList.get(i).GetTheme() != null)
                System.out.println(userList.get(i).GetName() + "; " + userList.get(i).GetEmail() + "; " + userList.get(i).GetType() + " (" + userList.get(i).GetTheme() + ")");
            else if (userList.get(i).GetType().equalsIgnoreCase(type))
                System.out.println(userList.get(i).GetName() + "; " + userList.get(i).GetEmail() + "; " + userList.get(i).GetType());
        }
    }
    ...
    public void ListArticleByType(String type) {
        if (type.equalsIgnoreCase("REPORT")) {
            for (int i = 0; i < articleList.size(); i++) {
                if (articleList.get(i).GetType().equalsIgnoreCase(type) && currentUser.GetName().equalsIgnoreCase(articleList.get(i).GetAuthor()))
                    System.out.println(articleList.get(i).GetTitle() + "; " + articleList.get(i).GetAuthor() + "; " + articleList.get(i).GetTheme() + "; " + articleList.get(i).GetTopic() + "; " + articleList.get(i).GetDate() + "; Likes: " + ((Report) articleList.get(i)).GetVotes());
            }
        } else if (type.equalsIgnoreCase("CHRONICLE")) {
            for (int i = 0; i < articleList.size(); i++) {
                if (articleList.get(i).GetType().equalsIgnoreCase(type) && currentUser.GetName().equalsIgnoreCase(articleList.get(i).GetAuthor()))
                    System.out.println(articleList.get(i).GetTitle() + "; " + ((Collaborator) currentUser).GetEditorName() + articleList.get(i).GetTheme() + "; " + articleList.get(i).GetTopic() + "; " + articleList.get(i).GetDate() + ((Chronicle) articleList.get(i)).GetPublishDate() + ((Chronicle) articleList.get(i)).GetTotalCommentsString());
            }
        }
    }
    ...
    public void Approve(String title, String date) {
        ...
        else if (!CanApprove(title))
            System.out.println("Not authorized to approve this chronicle.\n");
    ...
    public void ListTopicByType(String type, String topic) {
        for (int i = 0; i < articleList.size(); i++) {
            if (articleList.get(i).GetTopic().equalsIgnoreCase(topic) && articleList.get(i).GetType().equalsIgnoreCase(type) && articleList.get(i).GetType().equalsIgnoreCase("REPORT"))
                System.out.println(articleList.get(i).GetTitle() + "; " + articleList.get(i).GetAuthor() + "; " + articleList.get(i).GetTheme() + "; " + articleList.get(i).GetDate() + "; Likes: " + ((Report) articleList.get(i)).GetVotes());
            else if (articleList.get(i).GetTopic().equalsIgnoreCase(topic) && articleList.get(i).GetType().equalsIgnoreCase(type) && articleList.get(i).GetType().equalsIgnoreCase("CHRONICLE") && ((Chronicle) articleList.get(i)).IsPublished())
                System.out.println(articleList.get(i).GetTitle() + "; " + articleList.get(i).GetAuthor() + "; " + articleList.get(i).GetTheme() + ((Chronicle) articleList.get(i)).GetPublishDate() + ((Chronicle) articleList.get(i)).GetTotalCommentsString());
        }
    }
    ...
    public void ListThemeByType(String type, String theme) {
        for (int i = 0; i < articleList.size(); i++) {
            if (articleList.get(i).GetTheme().equalsIgnoreCase(theme) && articleList.get(i).GetType().equalsIgnoreCase(type) && articleList.get(i).GetType().equalsIgnoreCase("REPORT"))
                System.out.println(articleList.get(i).GetTitle() + "; " + articleList.get(i).GetAuthor() + "; " + articleList.get(i).GetTopic() + "; " + articleList.get(i).GetDate() + "; Likes: " + ((Report) articleList.get(i)).GetVotes());
            else if (articleList.get(i).GetTheme().equalsIgnoreCase(theme) && articleList.get(i).GetType().equalsIgnoreCase(type) && articleList.get(i).GetType().equalsIgnoreCase("CHRONICLE") && ((Chronicle) articleList.get(i)).IsPublished())
                System.out.println(articleList.get(i).GetTitle() + "; " + articleList.get(i).GetAuthor() + "; " + articleList.get(i).GetTopic() + ((Chronicle) articleList.get(i)).GetPublishDate() + ((Chronicle) articleList.get(i)).GetTotalCommentsString());
        }
    }
}
